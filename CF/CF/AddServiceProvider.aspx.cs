...
namespace CF
{
    public partial class AddServiceProvider : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into tblDetailsofVillageService(HdId,NameofProvider,Designation,ContactNumber,Department,Address) values(" + Session["HDid"] + ",'" + Name + "','" + designaton + "','" + Contact + "','" + Department + "','" + Address + "')";
