...
namespace CF
{
    public partial class InnovationInfo : System.Web.UI.Page
    {
        ...
        public void GetDetails()
        {
            ...
            string Getquery = "select * from tblInnovationImages";
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    string videos = path + ds.Tables[0].Rows[i]["Textarea"].ToString();
                    ds.Tables[0].Rows[i]["Textarea"] = videos;
                }
        ...
        protected void gallery_RowDataBound(object sender, GridViewRowEventArgs e)
        {

            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.Cells[0].ToString().Length > 0)
                {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string val = (string)this.gallery.DataKeys[rowIndex]["InnovationId"].ToString();
            string deleteQ = "delete from tblInnovationImages where InnovationId=" + val;
