<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="WfgFilter.aspx.cs" Inherits="CF.WfgFilter" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>WFG Filter</title>
    <script>
        ...
        function dounload(FileName) {
            debugger;
            window.open('GetFiles.aspx?FileName=' + FileName + '', '_blank');
        }
        ...
        <div class="content">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <a class="btn btn-danger" href="WFGInfo.aspx">Close</a>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h1 class="box-title">Filtered WFG's Info</h1>
                    ...
                    <ContentTemplate>
                        <div class="box-body">
                            <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                                <asp:GridView runat="server" CssClass="table table-striped table-bordered table-condensed table-hover infoarea" AlternatingRowStyle-CssClass="infoarea" ID="gvWFG" DataKeyNames="WfgNo, Status" AutoGenerateColumns="false" OnRowCommand="gvWFG_RowCommand" AllowSorting="true" OnPageIndexChanging="gvWFG_PageIndexChanging" AllowPaging="true" PageSize="50" OnSorting="gvWFG_Sorting" OnRowDataBound="gvWFG_RowDataBound" OnRowCreated="Gridview1_RowCreated">
                                    <Columns>
    ...
    <script>
        ...
        $('body').on('change', '.ColumnType', function () {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "WfgFilter.aspx/BindDataFromColumns",
                dataType: "json",
    ...
    <script>
        ...
        function BindColumns() {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "WfgFilter.aspx/BindColumns",
                dataType: "json",
                contentType: "application/json",
                success: function (res) {
                    $.each(res.d, function (data, value) {
