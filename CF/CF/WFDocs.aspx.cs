...
namespace CF
{
    public partial class WFDocs : System.Web.UI.Page
    {
        ...
        public void GetDetails()
        {
            ...
            string Getquery = "select DicID, WomenName, DocumentName from tblMasterDocuments a left outer join tblWFs b on a.ClientID=b.WfNo where a.UserType = 'WF'";
