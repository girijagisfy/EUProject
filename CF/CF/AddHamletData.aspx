<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddHamletData.aspx.cs" Inherits="CF.AddHamletData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Hamlet Data</title>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Hamlet Data</h3>
                ...
                <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtYear" runat="server" CssClass="form-control YearPicker" oninput="NumberCheck(this)" MaxLength="4" OnTextChanged="txtYear_TextChanged" AutoPostBack="true" />
                                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtYear" ErrorMessage="Select Year" CssClass="text-danger" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <asp:Panel ID="Panel14" runat="server" GroupingText="Status of Education in Village">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" id="dvPrimary1">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPrimarySchoolDistance" runat="server" CssClass="form-control" oninput="DecimalCheck(input)" />
                                </div>
                            </div>
                        ...
                        <div class="row" id="dvUpperPrimary6">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label238" runat="server" Text="Total no. of Boys 11-12 year Boys in village"></asp:Label>
                                    <asp:TextBox ID="txtUpperPrimary6to11Boys" runat="server" CssClass="form-control" oninput="NumberCheck(this)" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label239" runat="server" Text="Total no. of Girls 11-12 year Girls in village"></asp:Label>
                        ...
                        <div class="row" id="dvSecondary6">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label268" runat="server" Text="Total no. of Boys 13-15 year Boys in village"></asp:Label>
                                    <asp:TextBox ID="txtSecondary6to11Boys" runat="server" CssClass="form-control" oninput="NumberCheck(this)" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label269" runat="server" Text="Total no. of Girls 13-15 year Girls in village"></asp:Label>
                        ...
                        <div class="row" id="dvHigher6">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label291" runat="server" Text="Total no. of Boys 17-18 year Boys in village"></asp:Label>
                                    <asp:TextBox ID="txtHigherSecondary6to11Boys" runat="server" CssClass="form-control" oninput="NumberCheck(this)" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label312" runat="server" Text="Total no. of Girls 17-18 year Girls in village"></asp:Label>
                        ...
                        <div class="row" id="dvMadarsa6">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label248" runat="server" Text="Total no. of Boys 14-16 year Boys in village"></asp:Label>
                                    <asp:TextBox ID="txtMadrasa6to11Boys" runat="server" CssClass="form-control" oninput="NumberCheck(this)" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label279" runat="server" Text="Total no. of Girls 14-16 year Girls in village"></asp:Label>
