<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Innovation.aspx.cs" Inherits="CF.Innovation" %>
...
<body>
    ...
    <body>
       ...
       <div class="main-top" id="home" style="background-image: url(images/b2.jpg);     min-height: 60% !important">
        ...
        <section class="collection py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                <h3 class="title mb-lg-5 mb-md-4 mb-sm-4 mb-3">Our Innovation</h3>
                <!--row -->
                <div class="row">
                    <div class="col-lg-7 col-md-6 collection-w3layouts">
                        <h4 style="color:lightcoral">Tropical Fruit Mix Smoothie</h4>
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="HomePageStyles/images/g1.jpg" alt="news image" class="img-fluid">
                    </div>
                </div>
                <!--// row -->
                <!-- row -->
                <div class="row my-lg-5 my-md-4 my-3">
                    <div class="col-lg-5 col-md-6">
                        <img src="HomePageStyles/images/g2.jpg" alt="news image" class="img-fluid">
                    </div>
                    <div class="col-lg-7 col-md-6 collection-w3layouts">
                        <h4  style="color:lightcoral">Veggie Diet Pros And Cons</h4>
                        <p class="mt-2">sed do eiusmod tempor incididunt ut Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet, eiusmod tempor incididunt ut labore et consectetur adipiscing sed do eiusmod</p>
                        <div class="view-buttn mt-lg-4 mt-3">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="HomePageStyles/images/4.jpg" alt="news image" class="img-fluid">
                    </div>
                </div>--%>
                <!--// row ---%>->
            </div>
  ...
  <footer class="text-center text-white" style="background-color: #0a4275;">
    ...
    <div class="text-center p-3" style="background-color: #007a45;">
      ...
      <a class="text-white" href="https://childfundindia.org/" target="_blank">ChildFund India</a></strong> All rights reserved.  Developed and Managed by <a href="http://www.gisfy.co.in/" target="_blank"><img src="Images/gisfyLogo.jpg" style="height: 30px;" /></a>
