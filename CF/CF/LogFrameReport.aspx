<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="LogFrameReport.aspx.cs" Inherits="CF.LogFrameReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>Log frame Indicator</title>
        ...
        <form runat="server">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Log frame Indicator</h3>
