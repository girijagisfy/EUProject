<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="VillageHamlet.aspx.cs" Inherits="CF.VillageHamlet" %>
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        <a id="A1" runat="server" class="btn btn-primary" href="VillagesInfo.aspx"><i class="fa fa-arrow-left">&nbsp;Back</i></a>
                        <a id="btnAddNew" runat="server" class="btn btn-success" href="AddHamlet.aspx"><i class="fa fa-plus-circle">&nbsp;Add New</i></a>
                    </div>
                ...
                <div class="box-body">
                    <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                        <asp:GridView ID="Gridview1" runat="server" DataKeyNames="Hid" CssClass="table table-striped table-bordered table-condensed table-hover" AutoGenerateColumns="false" AllowSorting="True" EmptyDataRowStyle-CssClass="infoarea" AlternatingRowStyle-CssClass="infoarea" OnRowCommand="Gridview1_RowCommand" AllowPaging="true" PageSize="10" OnSorting="Gridview1_Sorting" OnPageIndexChanging="Gridview1_PageIndexChanging" OnRowCreated="Gridview1_RowCreated">
                            <Columns>
                                ...
                                <asp:ButtonField ButtonType="Link" ControlStyle-Font-Size="x-large" CommandName="btnEditData" ControlStyle-CssClass="nav-icon fa fa-edit" HeaderText="Edit Data" HeaderStyle-CssClass="text-blue" />
