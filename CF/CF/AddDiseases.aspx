<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddDiseases.aspx.cs" Inherits="CF.Diseases" %>
    ...
    <form id="form1" runat="server">
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-bord er">
                    <h3 class="box-title">Add Diseases in village</h3>
                    ...
                    <asp:Panel ID="Panel11" runat="server" GroupingText="Major prevalent Diseases in village">
                        ...
                        <div class="row">
                            <div class="box-footer clearfix">
                                <a id="btnCancel" runat="server" class="btn btn-danger" href="PrevalentDiseasesInfo.aspx">Cancel</a>
