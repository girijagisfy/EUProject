<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddFinanceLiteracy.aspx.cs" Inherits="CF.AddFinanceLiteracy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Financial literacy</title>
    <style>
        .LableSpace, label {
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Enter Name of banks in the village " ControlToValidate="txtBank" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Enter Banks distance from village (in KM) " ControlToValidate="txtBankdistance" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
