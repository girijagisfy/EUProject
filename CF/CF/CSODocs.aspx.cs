...
namespace CF
{
    public partial class CSODocs : System.Web.UI.Page
    {
        ...
        public void GetDetails()
        {
            ...
            string Getquery = "select DicID, CSOName, DocumentName from tblMasterDocuments a left outer join tblCSO b on a.ClientID=b.CSOID where a.UserType = 'CSO' order by CSOName";
