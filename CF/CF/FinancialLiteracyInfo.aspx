<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="FinancialLiteracyInfo.aspx.cs" Inherits="CF.FinancialLiteracyInfo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Financial literacy Info</title>
    <style>
        td {
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h1 class="box-title">Financial literacy Info</h1>
                    <div class="pull-right box-tools">
                        <a id="A1" runat="server" class="btn btn-primary" href="HamletDataInfo.aspx"><i class="fa fa-arrow-left">&nbsp;Back</i></a>
                        <a id="btnAddNew" runat="server" class="btn btn-success" href="AddFinanceLiteracy.aspx"><i class="fa fa-plus-circle">&nbsp;Add New</i></a>
                    </div>
                ...
                <div class="box-body">
                    <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                        <asp:GridView ID="gvFinance" runat="server" DataKeyNames="FLid" CssClass="table table-striped table-bordered table-condensed table-hover" AutoGenerateColumns="false" AllowSorting="True" EmptyDataRowStyle-CssClass="infoarea" AlternatingRowStyle-CssClass="infoarea" OnRowCommand="gvFinance_RowCommand" AllowPaging="true" PageSize="10" OnSorting="gvFinance_Sorting" OnPageIndexChanging="gvFinance_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:BoundField DataField="BankDistance" HeaderText="Bank Distance(in Km)" SortExpression="BankDistance" />
                                <asp:BoundField DataField="NameofcooperativeSociety" HeaderText="Co-operative Society" SortExpression="NameofcooperativeSociety" />
                                <asp:BoundField DataField="SocietyDistance" HeaderText="Society Distance" SortExpression="SocietyDistance" />
