<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="VillageFilter.aspx.cs" Inherits="CF.VillageFilter" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Villages Filter</title>
    <style>
        .loader {
            position: fixed;
            left: 50%;
        ...
        <div class="content">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <a class="btn btn-danger" href="VillagesInfo.aspx">Close</a>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h1 class="box-title">Filtered Villages's Info</h1>
                    ...
                    <ContentTemplate>
                        <div class="box-body">
                            <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                                <asp:GridView ID="gvVillage" runat="server" DataKeyNames="Vid, Status" CssClass="table table-striped table-bordered table-condensed table-hover" AutoGenerateColumns="false" AllowSorting="True" EmptyDataRowStyle-CssClass="infoarea" AlternatingRowStyle-CssClass="infoarea" OnRowCommand="gvVillage_RowCommand" AllowPaging="true" PageSize="30" OnSorting="gvVillage_Sorting" OnPageIndexChanging="gvVillage_PageIndexChanging" OnRowDataBound="gvVillage_RowDataBound" OnRowCreated="Gridview1_RowCreated">
                                    <Columns>
                                        <asp:BoundField DataField="CSOName" HeaderText="Name of CSO" SortExpression="NameofChief" />
    ...
    <script>
        ...
        $('body').on('change', '.ColumnType', function () {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "VillageFilter.aspx/BindDataFromColumns",
                dataType: "json",
    ...
    <script>
        ...
        function BindColumns() {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "VillageFilter.aspx/BindColumns",
                dataType: "json",
                contentType: "application/json",
                success: function (res) {
                    $.each(res.d, function (data, value) {
