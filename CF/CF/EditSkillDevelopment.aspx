<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="EditSkillDevelopment.aspx.cs" Inherits="CF.EditSkillDevelopment_aspx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit Skill Development</title>
    <style>
        .LableSpace, label {
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Diseases in village</h3>
