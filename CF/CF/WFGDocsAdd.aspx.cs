...
namespace CF
{
    public partial class WFGDocsAdd : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into tblMasterDocuments(DocumentName, ClientID, UserType) values('" + InputFileName + "','" + ddlwfg.SelectedValue + "','WFG')";
