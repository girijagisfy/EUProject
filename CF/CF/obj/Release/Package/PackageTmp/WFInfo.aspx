<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="WFInfo.aspx.cs" Inherits="CF.WFInfo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>WFs Info</title>
    <script>
        var loading;
        function ShowLoader() {
            debugger;
        ...
        <div class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h1 class="box-title">Women Farmers Information</h1>
                    <div class="pull-right box-tools">
                        <a runat="server" id="btnFilter" class="btn btn-primary" href="WfFilter.aspx"><i class="fa fa-filter">&nbsp;Filter</i></a>
                    ...
                    <div class="pull-right box-tools" style="margin-right: 10px;">
                        <asp:DropDownList runat="server" ID="ddlvillage" AutoPostBack="true" OnSelectedIndexChanged="ddlvillage_SelectedIndexChanged" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
                    <div runat="server" id="dvVillage" class="pull-right box-tools">
                        <label>Village</label>
                    </div>
                ...
                <div class="box-body">
                    <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                        <asp:GridView runat="server" CssClass="table table-striped table-bordered table-condensed table-hover infoarea" AlternatingRowStyle-CssClass="infoarea" ID="gvWF" DataKeyNames="WfNo, Status" AutoGenerateColumns="false" OnRowCommand="gvWF_RowCommand" PageSize="50" AllowSorting="true" AllowPaging="true" OnSorting="gvWF_Sorting" OnPageIndexChanging="gvWF_PageIndexChanging" OnRowDataBound="gvWF_RowDataBound" OnRowCreated="Gridview1_RowCreated">
                            <Columns>
