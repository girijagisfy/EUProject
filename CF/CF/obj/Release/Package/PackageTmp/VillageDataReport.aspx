<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="VillageDataReport.aspx.cs" Inherits="CF.VillageDataReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Village Hamlet Data</title>
    <script>
        function ShowAlert(msg, type) {
            ////debugger;
            if (type == 'success') {
                swal("", msg, type).then(function () {
                    window.location = "VillageDataReport.aspx";
                });
            }
            else {
                swal("", msg, type);
        ...
        <form runat="server">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Village Hamlet Data</h3>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Label ID="lblCSO" runat="server" Text="Select CSO"></asp:Label>
                ...
                <div class="box-footer">
                    <a href="VillagesInfo.aspx" class="btn btn-danger">Cancel</a>
