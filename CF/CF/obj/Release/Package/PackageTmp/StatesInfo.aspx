<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="StatesInfo.aspx.cs" Inherits="CF.StatesInfo" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h1 class="box-title">States Information</h1>
                    <div class="pull-right box-tools">
                        <a id="btnAddNew" runat="server" class="btn btn-success" href="AddState.aspx"><i class="fa fa-plus-circle">&nbsp;Add New</i></a>
                    </div>
                    <div class="pull-right box-tools" style="width: 20%; margin-right: 2%; margin-bottom: 1%;">

                        <asp:DropDownList runat="server" ID="searchStates" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="searchStates_SelectedIndexChanged">
                ...
                <div class="box-body">
                    <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                        <asp:GridView ID="gvStates" runat="server" DataKeyNames="StateId" CssClass="table table-striped table-bordered table-condensed table-hover" AutoGenerateColumns="false" AllowSorting="True" EmptyDataRowStyle-CssClass="infoarea" AlternatingRowStyle-CssClass="infoarea" OnRowCommand="gvStates_RowCommand" AllowPaging="true" OnSorting="gvStates_Sorting" OnPageIndexChanging="gvStates_PageIndexChanging">
                            <Columns>
