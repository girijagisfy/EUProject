<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="CSODocsAdd.aspx.cs" Inherits="CF.CSODocsAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add CSO Docs</title>
    <style>
        label {
            padding-left: 10px;
        }
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add CSO Docs</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <asp:FileUpload runat="server" class="custom-file-input form-control" onchange="showpreview(this)" ID="CsoDocs" accept=".pdf" />
                ...
                <div class="box-footer clearfix">
                    <a id="btnCancel" runat="server" class="btn btn-danger" href="CSODocs.aspx">Cancel</a>
