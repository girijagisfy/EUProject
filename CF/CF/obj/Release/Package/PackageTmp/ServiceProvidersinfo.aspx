<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="ServiceProvidersinfo.aspx.cs" Inherits="CF.ServiceProvidersinfo" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h1 class="box-title">Service Providers Info</h1>
                    <div class="pull-right box-tools">
                        <a id="A1" runat="server" class="btn btn-primary" href="HamletDataInfo.aspx"><i class="fa fa-arrow-left">&nbsp;Back</i></a>
                        <a id="btnAddNew" runat="server" class="btn btn-success" href="AddServiceProvider.aspx"><i class="fa fa-plus-circle">&nbsp;Add New</i></a>
                    </div>
                ...
                <div class="box-body">
                    <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                        <asp:GridView ID="gvCropping" runat="server" DataKeyNames="FIid" CssClass="table table-striped table-bordered table-condensed table-hover" AutoGenerateColumns="false" AllowSorting="True" EmptyDataRowStyle-CssClass="infoarea" AlternatingRowStyle-CssClass="infoarea" OnRowCommand="gvCropping_RowCommand" AllowPaging="true" PageSize="10" OnSorting="gvCropping_Sorting" OnPageIndexChanging="gvCropping_PageIndexChanging">
                            <Columns>
                                <asp:BoundField DataField="NameofHamlet" HeaderText="Hamlet Name" SortExpression="NameofHamlet" />
                                <asp:BoundField DataField="NameofProvider" HeaderText="Name of Provider" SortExpression="NameofProvider" />
