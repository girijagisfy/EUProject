<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="CsoFilter.aspx.cs" Inherits="CF.CsoFilter" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>CSO Filter</title>
    <script>
        ...
        <div class="content">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <a class="btn btn-danger" href="CsoInfo.aspx">Close</a>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h1 class="box-title">Filtered CSO Info</h1>
                    ...
                    <ContentTemplate>
                        <div class="box-body">
                            <div style="background: white; margin-left: -7.5px; margin-right: -7.5px">
                                <asp:GridView ID="Gridview1" runat="server" DataKeyNames="CsoId, Status" CssClass="table table-striped table-bordered table-condensed table-hover" AutoGenerateColumns="false" AllowSorting="True" EmptyDataRowStyle-CssClass="infoarea" AlternatingRowStyle-CssClass="infoarea" OnRowCommand="Gridview1_RowCommand" AllowPaging="true" OnSorting="Gridview1_Sorting" OnPageIndexChanging="Gridview1_PageIndexChanging" OnRowDataBound="Gridview1_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Link" ControlStyle-Font-Size="x-large" CommandName="btnEdit" ControlStyle-CssClass="nav-icon fa fa-edit" HeaderStyle-CssClass="text-blue" />
    ...
    <script>
        ...
        $('body').on('change', '.ColumnType', function () {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "CsoFilter.aspx/BindDataFromColumns",
                dataType: "json",
    ...
    <script>
        function BindColumns() {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "CsoFilter.aspx/BindColumns",
                dataType: "json",
                contentType: "application/json",
                success: function (res) {
                    $.each(res.d, function (data, value) {
