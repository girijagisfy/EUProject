<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="EditCso.aspx.cs" Inherits="CF.EditCso" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit CSO</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit CSO</h3>
                ...
                <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtregaddr" runat="server" placeholder="Address" oninput="SplCharCheck(this)" CssClass="form-control" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtregwebsite" runat="server" oninput="SplCharCheck(this)" placeholder="Website" CssClass="form-control" />
                                </div>
                            </div>
                        </div>
                    </asp:Panel>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtcraddr" runat="server" oninput="SplCharCheck(this)" placeholder="Address" CssClass="form-control" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtcrPhone" runat="server" oninput="MobileCheck(this)" placeholder="Mobile No , Seperator" CssClass="form-control" />
                                    ...
                                    <%-- <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtcrwebsite" runat="server" oninput="SplCharCheck(this)" placeholder="Website" CssClass="form-control" />
                                        </div>
                                    </div>--%>
                                </div>
                            </asp:Panel>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtcontname" runat="server" placeholder="Name of Person" oninput="SplCharCheck(this)" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label6" runat="server" Text="Address"></asp:Label>
                                    <asp:TextBox ID="txtcontAddr" runat="server" oninput="SplCharCheck(this)" placeholder="Address of Person" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label ID="Label7" runat="server" Text="Phone"></asp:Label>
                                    <asp:TextBox ID="txtcontphone" runat="server" MaxLength="10" oninput="NumberCheck(this)" placeholder="Mobile No of Person" CssClass="form-control" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtcontemail" runat="server" onblur="validateEmail(this,'emailidcontactperson','txtcontemail')" placeholder="Email of Person" CssClass="form-control" />
                            ...
                            <%-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtcontwebsite" runat="server" oninput="SplCharCheck(this)" placeholder="Website of Person" CssClass="form-control" />
                                </div>
                            </div>--%>
                        </div>
                    </asp:Panel>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtregno" runat="server" placeholder="Registration No" CssClass="form-control" oninput="SplCharCheck(this)" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtFCRAregno" runat="server" placeholder="Registration No" CssClass="form-control" oninput="SplCharCheck(this)" />
                        ...
                        <div class="row" id="dvPANno">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPanNo" runat="server" placeholder="PAN No" MaxLength="10" CssClass="form-control" oninput="SplCharCheck(this)" />
                        ...
                        <div class="row" id="dv12Ano">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txt12ANo" runat="server" oninput="SplCharCheck2(this)" placeholder="12 A No" CssClass="form-control" />
                        ...
                        <div class="row" id="dv80Gno">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txt80GNo" runat="server" oninput="SplCharCheck(this)" placeholder="80G No" CssClass="form-control" />
                        ...
                        <asp:Panel runat="server" GroupingText="Other programmatic focus" ID="pnlFocus">
                            <div class="row">
                                <div class="col-md-3 form-group" id="dvfocus0">
                                    <asp:TextBox runat="server" ID="txtprogrammatic0" oninput="SplCharCheck2(this)" onblur="GetFilterData()" class="form-control" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtWSHG" runat="server" oninput="SplCharCheck2(this)" placeholder="Women SHG" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Women Farmers Groups"></asp:Label>
                                    <asp:TextBox ID="txtWFG" runat="server" oninput="SplCharCheck2(this)" placeholder="Women Farmers Groups" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Adolescent Girls Group"></asp:Label>
                                    <asp:TextBox ID="txtAGG" runat="server" oninput="SplCharCheck2(this)" placeholder="Adolescent Girls Group" CssClass="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtJLG" runat="server" oninput="SplCharCheck2(this)" placeholder="Joint Liability Group" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Other If any"></asp:Label>
                                    <asp:TextBox ID="txtOIF" runat="server" oninput="SplCharCheck2(this)" placeholder="Other If any " CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Detail of Fedration if any"></asp:Label>
                                    <asp:TextBox ID="txtDFA" runat="server" oninput="SplCharCheck2(this)" placeholder="Detail of Fedration if any" CssClass="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TXTNariSingh" runat="server" placeholder="Nari Sangh" CssClass="form-control" />
                                </div>
                            </div>
                        </div>
                    </asp:Panel>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <asp:Label ID="Label18" runat="server" Text="Upload Your Logo"></asp:Label>
                                <div class="custom-file form-group" style="overflow: hidden;">
                                    <asp:FileUpload runat="server" class="custom-file-input" ID="Csologo" onchange="previewImage(this);" accept="image/png,image/jpg,image/jpeg" />
                        ...
                        <div class="col-md-4">
                            <asp:Image runat="server" ID="imgLogo" Style="height: 150px" />
                        </div>
                    </div>
                </div>
                <div class="box-footer clearfix">
                    <a id="btnCancel" runat="server" class="btn btn-danger" href="CsoInfo.aspx">Cancel</a>
            ...
            <div class="modal fade bd-example-modal-lg" id="PreviewPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div>
                                    <table class="Preview" id="tbldynamic" border="1" rules="all">
                                        ...
                                        <%--                                    <tr>
                                        <td colspan="4">
                                            <table class="Preview" rules="all" id="tdotherngo">
                                            </table>
                                        </td>
                                    </tr>--%>
                                    </table>
                                ...
                                <div>
                                    <table class="Preview" border="1" rules="all">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <img src="" id="ImgPreview" title="Logo" style="height: 50px" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="box-footer clearfix">
                            <a onclick="printDiv('printableArea')" target="_blank" class="btn btn-info">Print</a>
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" ValidationGroup="Decleration" Text="Update" OnClick="btnUpdate_Click" />
    ...
    <script type="text/javascript">
            ...
            if (data != null) {
                ...
                if (datasplit.length > 0) {
                    for (var i = 0; i < datasplit.length; i++) {
                        ...
                        if (i == 0) {
                            $("#<%=txtNGOName0.ClientID%>").val(secsplit[0]);
                            $("#<%=txtNGODate0.ClientID%>").val(secsplit[1]);
                            $("#txtNGOExpiry0").val(secsplit[2]);
                        }
                        else {
                            $("#dynamicNGO").append('<div class="row" id="NGO' + id + '"><div class="col-md-3 form-group"><label>NGO Name</label><input type="text" id="txtNGOName' + id + '" oninput="SplCharCheck2(this)" value="' + secsplit[0] + '" onblur="GetFilterData()" class="form-control" /></div><div class="col-md-3 form-group"><label>Date of Registration</label> <div class="input-group date"><div class="input-group-addon"><i class="fa fa-calendar"></i></div><input id="txtNGODate' + id + '" value="' + secsplit[1] + '" onblur="GetFilterData()" Class="form-control pull-right datePicker" placeholder="dd-MM-yyyy" /></div></div><div class="col-md-3 form-group"><label>Date of Expiry(if Any)</label><div class="input-group date"><div class="input-group-addon"><i class="fa fa-calendar"></i></div><input id="txtNGOExpiry' + id + '" value="' + secsplit[2] + '" onblur="GetFilterData()" Class="form-control pull-right datePicker" placeholder="dd-MM-yyyy" /></div></div><div class="col-md-1 form-group"><br><br><a onclick = "RemoveCurrentDiv(&apos;#NGO' + id + '&apos;);" style="color:red"><i class="fa fa-remove"></i></a></div></div>');
                            id++;
                        }
                    }
                }
        ...
        function GetOtherFields() {
            var data = $("#<%=hfFocusData.ClientID %>").val();
            var datasplit = data.split(',');
            var id = 1;
            debugger;
            if (datasplit.length > 0) {
                for (var i = 0; i < datasplit.length; i++) {
                    if (i == 0) {
                        $("#<%=txtprogrammatic0.ClientID%>").val(datasplit[i]);
                    }
                    else {
                        $("#dynamicprogrammatic").append('<div id="dvfocus' + id + '"><div class="col-md-3 form-group" ><input type ="text" id ="txtprogrammatic' + id + '" value="' + datasplit[i] + '" onblur ="GetFocusData()" oninput="SplCharCheck2(this)" class= "form-control" /></div><div class="col-md-1 form-group"><a onclick = "RemoveFocusDiv(&apos;#dvfocus' + id + '&apos;);" style="color:red"><i class="fa fa-remove"></i></a></div></div>');
                        id++;
                    }
                }
            }
        ...
        function showpreview(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgLogo.ClientID%>').css('visibility', 'visible');
        ...
        function ShowPreview() {
            ...
            console.log($("#<%=rbl12A.ClientID%> input:checked").val());
            ...
            if ($("#<%=rblWPRIL.ClientID%> input:checked").val() == "Yes") {
                $("#tdIGPENo").html($("#<%=txtWPRIL1.ClientID%>").val());
                $("#tdIGPEAss").html($("#<%=txtWPRIL2.ClientID%>").val());
                $("#tdIGPEDeta").html($("#<%=txtWPRIL3.ClientID%>").val());
            }
            else {
                $("#tdIGPENo").html("");
                $("#tdIGPEAss").html("");
            ...
            debugger;
            var url = "";
            if ($("#<%=Csologo.ClientID%>").get(0).files.length == 0) {
                url = $("#<%=imgLogo.ClientID%>").prop('src');
                $("#ImgPreview").attr('src', url);
            }
           <%-- else {
                url = $("#<%=Csologo.ClientID%>").val();
            }--%>
            //$("#imgpreview").attr('src', url);
