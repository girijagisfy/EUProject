<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddWF.aspx.cs" Inherits="CF.AddWF" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Woman Farmer</title>
    <style>
        .LableSpace, label {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Woman Farmer</h3>
                ...
                <div class="box-body">
                    <asp:Panel runat="server" ID="panel4">
                        ...
                        <div class="row" id="dvcheck">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <asp:Label ID="Label52" runat="server" Text="Name"></asp:Label><b style="color: red"> *</b>
                                    <asp:TextBox ID="txtCheckName" runat="server" oninput="SplCharCheck(this)" CssClass="form-control"></asp:TextBox>
                                    <asp:CustomValidator ValidationGroup="PreviewCheck" ID="CVCheckName" ValidateEmptyText="true" ControlToValidate="txtCheckName" SetFocusOnError="true" ClientValidationFunction="CheckNameValidate" Display="Dynamic" ErrorMessage="Please Enter Name" CssClass="text-danger" runat="server"></asp:CustomValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <asp:Label ID="Label53" runat="server" Text="Name Of Husband/Father"></asp:Label><b style="color: red"> *</b>
                                    <asp:TextBox ID="txtCheckFather" runat="server" CssClass="form-control" oninput="SplCharCheck(this)"></asp:TextBox>
                                    <asp:CustomValidator ValidationGroup="PreviewCheck" ID="CVCheckFather" ValidateEmptyText="true" ControlToValidate="txtCheckFather" SetFocusOnError="true" ClientValidationFunction="CheckFatherValidate" Display="Dynamic" ErrorMessage="Please Enter Name Of Husband/Father" CssClass="text-danger" runat="server"></asp:CustomValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <asp:Label ID="lblCheckDOB" runat="server" Text="DOB"></asp:Label><b style="color: red"> *</b>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <asp:TextBox ID="txtCheckDOB" runat="server" CssClass="form-control pull-right datePicker" placeholder="dd-MM-yyyy"></asp:TextBox>
                                    </div>
                                    <asp:CustomValidator ValidationGroup="PreviewCheck" ID="CVCheckDOB" ValidateEmptyText="true" ControlToValidate="txtCheckDOB" SetFocusOnError="true" ClientValidationFunction="CheckDOBValidate" Display="Dynamic" ErrorMessage="Please Enter Date Of Birth" CssClass="text-danger" runat="server"></asp:CustomValidator>
                                </div>
                            </div>
                        ...
                        <div class="row" id="dvGrid">
                            <div class="box-body">
                                <asp:GridView runat="server" CssClass="table table-striped table-bordered table-condensed table-hover infoarea" AlternatingRowStyle-CssClass="infoarea" ID="CheckIO" DataKeyNames="FPCMemberId" AutoGenerateColumns="false" OnRowCommand="CheckIO_RowCommand" AllowSorting="true" OnSorting="CheckIO_Sorting">
                                    <Columns>
                                        <asp:BoundField DataField="MemberName" HeaderText="Name" SortExpression="MemberName" />
                                        <asp:BoundField DataField="FatherorHusbandName" HeaderText="Father/Husband Name" SortExpression="FatherorHusbandName" />
                                        <asp:BoundField DataField="DOB" HeaderText="Date Of Birth" SortExpression="DOB" />


                                        <asp:ButtonField ButtonType="Link" ControlStyle-Font-Size="x-large" CommandName="btnApply" Text="Apply" />
                                        <%-- <asp:ButtonField ButtonType="Link" ControlStyle-ForeColor="red" ControlStyle-Font-Size="x-large" CommandName="btnDelete" ControlStyle-CssClass="nav-icon fas fa-trash-alt" />--%>
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row" runat="server">
                                <asp:Panel ID="pnlVillage" runat="server">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label28" runat="server" Text="Gram Panchayat:"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-md-3" id="dvOtherEducation">
                                <div class="form-group">
                                    ...
                                    <asp:CustomValidator runat="server" ControlToValidate="txtOtherQualification" ValidateEmptyText="true" ValidationGroup="PreviewCheck" ErrorMessage="Please Enter Other Qualification" Display="Dynamic" ClientValidationFunction="ValidateOtherQualification" CssClass="text-danger" SetFocusOnError="true"></asp:CustomValidator>
                                </div>
                            </div>
                        </div>
                        <div id="dvBankName">
                    ...
                    <div class="box-footer clearfix">
                        <a id="btnCancel" runat="server" class="btn btn-danger" href="WFInfo.aspx">Cancel</a>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content" id="printableArea">
                            ...
                            <div class="box-footer clearfix">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" ValidationGroup="Decleration" Text="Save" OnClick="btnSubmit_Click" />
    ...
    <script type="text/javascript">
        ...
        $('#<%=rblIsFPCMember.ClientID %>').change(function () {
            ////debugger;
            var ddl = $("#<%= rblIsFPCMember.ClientID %> input:checked").val();
            if (ddl == 'Yes') {
                document.getElementById('dvcheck').style.display = "block";
            } else {
                document.getElementById('dvcheck').style.display = "none";
        ...
        function FPCNameValidate(source, arguments) {
            var txt = document.getElementById('ContentPlaceHolder1_ddlFPCName');
        ...
        function CheckNameValidate(source, arguments) {
            ////debugger;

            // var name = document.getElementById('ContentPlaceHolder1_txtLandHaving');
            var name = document.getElementById('<%=txtCheckName.ClientID%>');
            //var ddl = document.getElementById('ContentPlaceHolder1_rblRationCard');
            var ddl = $("#<%= rblIsFPCMember.ClientID %> input:checked").val();
        ...
        function CheckFatherValidate(source, arguments) {
            ////debugger;

            // var name = document.getElementById('ContentPlaceHolder1_txtLandHaving');
            var name = document.getElementById('<%=txtCheckFather.ClientID%>');
            //var ddl = document.getElementById('ContentPlaceHolder1_rblRationCard');
            var ddl = $("#<%= rblIsFPCMember.ClientID %> input:checked").val();
        ...
        function CheckDOBValidate(source, arguments) {
            ////debugger;

            // var name = document.getElementById('ContentPlaceHolder1_txtLandHaving');
            var name = document.getElementById('<%=txtCheckDOB.ClientID%>');
            //var ddl = document.getElementById('ContentPlaceHolder1_rblRationCard');
            var ddl = $("#<%= rblIsFPCMember.ClientID %> input:checked").val();
    ...
    <script>
        ...
        function ShowPreview() {
            ...
            $("#tdICT").html($("#<%=rblICT.ClientID%> input:checked").val());
            $("#tdOnFarm").html($("#<%=rblfarm.ClientID%> input:checked").val());
            $("#tdOffFarm").html($("#<%=rblOfffarm.ClientID%> input:checked").val());
            $("#tdSolely").html($("#<%=rblparticipate.ClientID%> input:checked").val());
            $("#tdjointly").html($("#<%=rbljointly.ClientID%> input:checked").val());
            $("#tdPercentage").html($("#<%=txtPercentage.ClientID%>").val());
            $("#tdLiteracy").html($("#<%=txtfinancial.ClientID%>").val());
            $("#tdDecisions").html($("#<%=txtdecisions.ClientID%>").val());
           ...
           <%-- $("#tdIrrigationSource").html($("#<%=txtIrrigationSpecify.ClientID%>").val());--%>
