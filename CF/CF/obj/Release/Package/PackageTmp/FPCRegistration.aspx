<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="FPCRegistration.aspx.cs" Inherits="CF.FPCRegistration" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        div#ContentPlaceHolder1_pnlSupporttDetails legend {
            font-size: 18px;
        }

        div#ContentPlaceHolder1_pnlBankDetails legend {
            font-size: 18px;
        }

        div#ContentPlaceHolder1_pnlIdProofs legend {
            font-size: 18px;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">FPC Registration</h3>
                ...
                <div class="box-body">
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" InitialValue="Select" CssClass="text-danger" ErrorMessage="Please Select State" ControlToValidate="ddlState" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="Select" CssClass="text-danger" ErrorMessage="Please Select District" ControlToValidate="ddlDistrict" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="Select" CssClass="text-danger" ErrorMessage="Please Select Block" ControlToValidate="ddlBlocks" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Select CSO Name" ControlToValidate="ddlCSO" SetFocusOnError="true" InitialValue="Select" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </ContentTemplate>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter FPC Name" ControlToValidate="txtFPCName" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter contact number" ControlToValidate="txtFPCConcact" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator runat="server" Display="Dynamic" ControlToValidate="txtFPCConcact" ErrorMessage="Enter Valid Mobile Number" ValidationExpression="^([0-9]{10})$" CssClass="text-danger" SetFocusOnError="true" ValidationGroup="PreviewCheck"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter valid email" ControlToValidate="txtFPCEmail" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Address" ControlToValidate="txtFPCAddress" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </asp:Panel>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Male Members" ControlToValidate="txtmaleMembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Female Members" ControlToValidate="txtfemaleMembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Transgender Members" ControlToValidate="txtTransgenderMembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter SF/MF Members" ControlToValidate="txtSFMFmembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                        <asp:CompareValidator runat="server" CssClass="text-danger" ErrorMessage="SF/MF members should be less than or equal to total members" ControlToCompare="txtTotalMembers" Type="Integer" ControlToValidate="txtSFMFmembers" Operator="LessThanEqual" Display="Dynamic" SetFocusOnError="true"></asp:CompareValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter ST Members" ControlToValidate="txtSTmembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter SC Members" ControlToValidate="txtSCMembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter OBC Members" ControlToValidate="txtOBCMembers" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter General Members" ControlToValidate="txtGeneral" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Villages Covered" ControlToValidate="txtVillgesCovered" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Blocks Covered" ControlToValidate="txtBlocksCovered" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Districts Covered" ControlToValidate="txtDistrictsCovered" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter No.of Shares Mobilized" ControlToValidate="txtNoofSharesMobilized" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <%-- till this --%>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Shares Mobilized" ControlToValidate="txtSharedMoneyMobilized" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" SetFocusOnError="true" ControlToValidate="ddlSFACEquity" InitialValue="Select" ErrorMessage="Select SFAC Equity Support Availed" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3" id="dvEquityGrant">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Equity Grant Fund" SetFocusOnError="true" Display="Static" ClientValidationFunction="validateEquityGrant"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Registration Date" ControlToValidate="txtFPCRegistrationDate" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="Select" CssClass="text-danger" ErrorMessage="Please Select Legal Act" ControlToValidate="ddlLegalActFPC" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row" id="dvOtherLegalAct">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" CssClass="text-danger" ErrorMessage="Enter Legal Act under Which FPC is Registered (if others)" SetFocusOnError="true" Display="Static" ClientValidationFunction="validateOtherLegalAct"></asp:CustomValidator>
                                    </div>
                                </div>
                            </div>
                        </asp:Panel>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter CIN Number" ControlToValidate="txtCINNumber" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" SetFocusOnError="true" ControlToValidate="ddlSupportTaken" InitialValue="Select" ErrorMessage="Select Support Taken from other Agency" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtNameofAgency0" runat="server" CssClass="text-danger" ValidateEmptyText="true" ErrorMessage="Please Enter Name of Agency" ClientValidationFunction="validateNameofAgency" SetFocusOnError="true" Display="Static"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtNameofScheme0" runat="server" CssClass="text-danger" ValidateEmptyText="true" ErrorMessage="Please Enter Name of Scheme" ClientValidationFunction="validateNameofScheme" SetFocusOnError="true" Display="Static"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtSupport0" runat="server" CssClass="text-danger" ValidateEmptyText="true" ErrorMessage="Please Enter Support" ClientValidationFunction="validateSchemeSupport" SetFocusOnError="true" Display="Static"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtSupportTakenDate0" runat="server" CssClass="text-danger" ValidateEmptyText="true" ErrorMessage="Please Enter Date" ClientValidationFunction="validateSchemeDate" SetFocusOnError="true" Display="Static"></asp:CustomValidator>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Bank Name" ControlToValidate="txtBankName0" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Bank Account Number" ControlToValidate="txtFPCBankNumber0" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Account Type" ControlToValidate="txtFPCAccountType0" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Bank Branch" ControlToValidate="txtBankBranch0" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter IFSC Code" ControlToValidate="txtICSCCode0" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        ...
                        <asp:Panel runat="server" GroupingText="ID Proof Details" ID="pnlIdProofs">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Business Address" ControlToValidate="txtFPCBusinessAddress" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="rblPAN" CssClass="text-danger" ErrorMessage="Please Select an Option" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row" id="dvPANno">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtPanNo" ErrorMessage="Please Enter PAN Number" Display="Dynamic" ClientValidationFunction="ValidatePANNo" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtPanDate" ErrorMessage="Please Enter PAN Date" Display="Dynamic" ClientValidationFunction="ValidatePANDate" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="rblTAN" CssClass="text-danger" ErrorMessage="Please Select an Option" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row" id="dvTANno">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtTanNo" ErrorMessage="Please Enter TAN Number" Display="Dynamic" ClientValidationFunction="ValidateTANNo" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtTanDate" ErrorMessage="Please Enter TAN Date" Display="Dynamic" ClientValidationFunction="ValidateTANDate" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="rblGST" CssClass="text-danger" ErrorMessage="Please Select an Option" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row" id="dvGSTno">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtGSTNo" ErrorMessage="Please Enter GST No" Display="Dynamic" ClientValidationFunction="ValidateGSTNo" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtGSTDate" ErrorMessage="Please Enter GST Date" Display="Dynamic" ClientValidationFunction="ValidateGSTDate" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="rblServiceTax" CssClass="text-danger" ErrorMessage="Please Select an Option" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row" id="dvServiceTax">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtServiceTAXNumber" ErrorMessage="Please Enter  Service Tax Number" Display="Dynamic" ClientValidationFunction="ValidateServiceTaxNumber" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ControlToValidate="txtServiceTaxDate" ErrorMessage="Please Enter Service Tax Date" Display="Dynamic" ClientValidationFunction="ValidateServiceTaxDate" ValidateEmptyText="true" SetFocusOnError="true" CssClass="text-danger"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Business license Taken" ControlToValidate="ddlBusinessTaken" SetFocusOnError="true" Display="Dynamic" InitialValue="Select"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div id="dvBusiness">
                                <div class="row" runat="server">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtLicenceName0" ValidateEmptyText="true" runat="server" CssClass="text-danger" ClientValidationFunction="BusinessLicenceNameValidate" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter License Name"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtLicenseNumber0" ValidateEmptyText="true" runat="server" CssClass="text-danger" ClientValidationFunction="BusinessLicenceNumberValidate" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter License Number"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtLicenceNameauthority0" ValidateEmptyText="true" runat="server" CssClass="text-danger" ClientValidationFunction="BusinessLicenceNameauthorityValidate" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter License Number Authority"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CustomValidator ControlToValidate="txtLicenceRegistrationDate0" ValidateEmptyText="true" runat="server" CssClass="text-danger" ClientValidationFunction="BusinessLicenceDateValidate" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter License Registration Date"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter OverView" ControlToValidate="txtOverview" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Mission" ControlToValidate="txtMission" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <asp:Label ID="Label59" runat="server" Text="Vision Statement"></asp:Label><b style="color: red"> *</b>
                                    <asp:TextBox runat="server" ID="txtVission" oninput="SplCharCheck(this)" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Vision" ControlToValidate="txtVission" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Business Model " ControlToValidate="txtBusinessModel" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please enter social and environment " ControlToValidate="txtSocialandenvironment" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </asp:Panel>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Select Team Members" ControlToValidate="ddlTeamMembers" SetFocusOnError="true" InitialValue="Select" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ID="cvEmpName" ValidateEmptyText="true" ClientValidationFunction="EmpNameValidate" CssClass="text-danger" ErrorMessage="Please Enter Employee Name" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ID="cvGender" ClientValidationFunction="GenderValidate" CssClass="text-danger" ErrorMessage="Please Select Gender" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator runat="server" ID="cvContact" ValidateEmptyText="true" ClientValidationFunction="ContactValidate" CssClass="text-danger" ErrorMessage="Please Enter Contact Number" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                        <asp:RegularExpressionValidator runat="server" Display="Dynamic" ControlToValidate="txtContactNumber0" ErrorMessage="Enter Valid Mobile Number" ValidationExpression="^([0-9]{10})$" CssClass="text-danger" SetFocusOnError="true" ValidationGroup="PreviewCheck"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ControlToValidate="ddlDesignation0" runat="server" ID="CustomValidator1" ClientValidationFunction="DesignationValidate" CssClass="text-danger" ErrorMessage="Please Select Designation" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ControlToValidate="txtDOJ0" ValidateEmptyText="true" runat="server" CssClass="text-danger" ClientValidationFunction="DOJoinValidate" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter Date of Joining"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Select Directors Appointed" ControlToValidate="ddlDirectors" SetFocusOnError="true" InitialValue="Select" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div id="dvDirectors">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ValidateEmptyText="true" ControlToValidate="txtDirectorsName0" runat="server" ID="CustomValidator2" ClientValidationFunction="DirectorNameValidate" CssClass="text-danger" ErrorMessage="Please Enter Name" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ValidateEmptyText="true" ControlToValidate="ddlDirectorGender0" runat="server" ID="CustomValidator3" ClientValidationFunction="DirectorGenderValidate" CssClass="text-danger" ErrorMessage="Please Select Gender" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ValidateEmptyText="true" ControlToValidate="txtDirectorContact0" runat="server" ID="CustomValidator4" ClientValidationFunction="DirectorContactValidate" CssClass="text-danger" ErrorMessage="Please Enter Contract number" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                        <asp:RegularExpressionValidator runat="server" Display="Dynamic" ControlToValidate="txtDirectorContact0" ErrorMessage="Enter Valid Mobile Number" ValidationExpression="^([0-9]{10})$" CssClass="text-danger" SetFocusOnError="true" ValidationGroup="PreviewCheck"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ValidateEmptyText="true" ControlToValidate="ddlDirectorType0" runat="server" ID="CustomValidator5" ClientValidationFunction="DirectorTypeValidate" CssClass="text-danger" ErrorMessage="Please Select Type of Appointment" SetFocusOnError="true" Display="Dynamic"></asp:CustomValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:CustomValidator ControlToValidate="txtDirectorDOJ0" ValidateEmptyText="true" runat="server" CssClass="text-danger" ClientValidationFunction="DirectorDOJoinValidate" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Enter Date of Joining"></asp:CustomValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <asp:Panel runat="server" GroupingText="Credentials">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter User Name" ControlToValidate="txtUserName" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ErrorMessage="Please Enter Password" ControlToValidate="txtPassword" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtConfirmPassword" CssClass="text-danger" ErrorMessage="Password mismatched" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <%--                                            <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ControlToValidate="fuFpcLogo" Display="Dynamic" SetFocusOnError="true" ErrorMessage="Upload FPC Logo"></asp:RequiredFieldValidator>--%>
                                            <asp:RegularExpressionValidator ID="RegExValFileUploadFileType" runat="server"
                                                ControlToValidate="fuFpcLogo"
                                                ErrorMessage="Only .jpg,.png,.jpeg Files are allowed" CssClass="text-danger" Display="Dynamic" ValidationExpression="(.*?)\.(jpg|jpeg|png|JPG|JPEG|PNG)$"></asp:RegularExpressionValidator>
                                            <%--<asp:CustomValidator   runat="server" CssClass="text-danger" ErrorMessage="Image size should be less than 100kb and ratio 100 x 100" ClientValidationFunction="checkFileSizeandRatio" Display="Static" SetFocusOnError="true"></asp:CustomValidator>--%>
                       ...
                       <div class="col-md-3 form-group" style="margin-left:5px">
                            ...
                            <div class="custom-file form-group" style="margin-left: -6px;overflow: hidden;">
                                <asp:FileUpload runat="server" accept=".pdf" class="custom-file-input" ID="fileuploadnew"/>
                                <label class="custom-file-label" for="customFile">Choose file</label>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <%-- <asp:CustomValidator runat="server" ID="CheckBoxRequired" EnableClientScript="true" OnServerValidate="CheckBoxRequired_ServerValidate" CssClass="text-danger" ClientValidationFunction="CheckBoxRequired_ClientValidate" ErrorMessage="You must select this box to proceed." SetFocusOnError="true" Display="Dynamic" ValidationGroup="CheckAgree"></asp:CustomValidator>--%>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function ShowPreview() {
        ...
        $("#tdPANStatus").html($("#<%=rblTAN.ClientID%> input:checked").val());
        if ($("#<%=rblTAN.ClientID%> input:checked").val() == "Yes") {
        ...
        if ($("#<%=ddlDirectors.ClientID%>").val() == "Yes") {
            ...
            if (directors != "") {
                ...
                for (var i = 0; i < directorsArray.length; i++) {
                    ...
                    if (i == 0) {
                        $('#dynamictdDirectorsAppointed').append('<tr class="previewDyanamicRow"><td rowspan="' + directorsArray.length + '">' + $("#<%=ddlDirectors.ClientID%>").val() + '</td><td>' + DirectorData[0] + '</td><td>' + DirectorData[1] + '</td><td>' + DirectorData[2] + '</td><td>' + DirectorData[3] + '</td><td>' + DirectorData[4] + '</td><td>' + DirectorData[5] + '</td></tr>');
                    }
                    else {
    ...
    function GetDirectorsAppointedData() {
        ...
        if ($("#<%=ddlDirectors.ClientID%>").val() == "Yes") {
            ...
            DataD = $("#<%=txtDirectorsName0.ClientID%>").val() + ':' + $("#<%=ddlDirectorGender0.ClientID%> option:selected").val() + ':' + $("#<%=txtDirectorContact0.ClientID%>").val() + ':' + $("#<%=ddlDirectorType0.ClientID%>").val() + ':' + $("#<%=txtDirectorDOJ0.ClientID%>").val() + ':' + $("#<%=txtDirectorDOR0.ClientID%>").val();
            ...
            for (var i = 1; i < DataCountD; i++) {
                ...
                if ($('#' + txtDirectorName).val() != undefined && $('#' + ddlDirectorGender + " option:selected").val() != undefined && $('#' + txtDirectorDOJ).val() != undefined && $('#' + txtDirectorDOR).val() != undefined) {
                    if ($('#' + txtDirectorName).val() != '' && $('#' + ddlDirectorGender + " option:selected").val() != '' && $('#' + txtDirectorContact).val() != '' && $('#' + ddlDirectorType + " option:selected").val() != '' && $('#' + txtDirectorDOJ).val() != '') {
                        if (DataD != "") {
                            DataD += '$' + $('#' + txtDirectorName).val() + ':' + $('#' + ddlDirectorGender + " option:selected").val() + ':' + $('#' + txtDirectorContact).val() + ':' + $('#' + ddlDirectorType + " option:selected").val() + ':' + $('#' + txtDirectorDOJ).val() + ':' + $('#' + txtDirectorDOR).val();
                        }
                        else {
                            DataD += $('#' + txtDirectorName).val() + ':' + $('#' + ddlDirectorGender + " option:selected").val() + ':' + $('#' + txtDirectorContact).val() + ':' + $('#' + ddlDirectorType + " option:selected").val() + ':' + $('#' + txtDirectorDOJ).val() + ':' + $('#' + txtDirectorDOR).val();
                        }
    ...
    function Upload() {
        ...
        var fileUpload = document.getElementById("<%=fuFpcLogo.ClientID%>");
            ...
            if (typeof (fileUpload.files) != "undefined") {
                ...
                reader.onload = function (e) {
                    ...
                    image.onload = function () {
                        ...
                        if (size > 100 || height > 100 || width > 100) {
                            alert("Height and Width must not exceed 100px.");
                            $('#lblFileDetails').html('Image size should be less than 100kb and ratio 100 x 100. Uploaded file size : ' + size + 'kb and ratio : ' + height + ' x ' + width);
                            return false;
                        }
    ...
    function previewImage(input) {
        ...
        //var size = parseFloat((input.files[0].size) / 1024).toFixed(2);
        //var img = document.getElementById('imgPreview');
        //var height = parseFloat(input.files[0].height);
        //var width = parseFloat(input.files[0].width);
        ////console.log(img); //console.log(input.files[0]); //console.log(size); //console.log(height); //console.log(width);

        //if (size <= 100 && height <= 100 && width <= 100) {
        //    //$('#btnPreview').preventDefault();
        //}
        //else {
        //    $('#lblFileDetails').html('Image size should be less than 100kb and ratio 100 x 100. Uploaded file size : ' + size + 'kb and ratio : ' + height + ' x ' + width);
        //    //$('#btnPreview').click();
    ...
    function validateSchemeSupport(source, arguments) {
        ...
        var ddl = $("#<%= ddlSupportTaken.ClientID %> option:selected").val();
    ...
    function ContactValidate(source, arguments) {
        ...
        if (ddl == 'Yes') {
            ...
            document.getElementById('<%= txtContactNumber0.ClientID %>').value = '';
            arguments.IsValid = true;
        }
    }
    ...
    function BusinessLicenceDateValidate(source, arguments) {
       ...
       <%-- function CheckBoxRequired_ClientValidate(source, arguments) {

            if (document.getElementById("<%=cbConfirm.ClientID %>").checked == true) {
                arguments.IsValid = true;
            } else {
                arguments.IsValid = false;
            }
    ...
    function DirectorGenderValidate(source, arguments) {
    ...
    function DirectorContactValidate(source, arguments) {
        ...
        if (ddl == 'Yes') {
            ...
            document.getElementById('<%= txtDirectorContact0.ClientID %>').value = '';
            arguments.IsValid = true;
        }
    }

    function DirectorTypeValidate(source, arguments) {
