<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddHamlet.aspx.cs" Inherits="CF.AddHamlet" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Hamlet</title>
    <style>
        .LableSpace, label {
