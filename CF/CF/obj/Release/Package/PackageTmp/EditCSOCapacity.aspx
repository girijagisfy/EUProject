<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="EditCSOCapacity.aspx.cs" Inherits="CF.EditCSOCapacity" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit CSO Capacity</title>
        ...
        <form id="form1" runat="server">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit CSO Capacity</h3>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" ID="txtYear" CssClass="form-control YearPicker" AutoPostBack="true" OnTextChanged="txtYear_TextChanged" ReadOnly="true" Enabled="false"></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlQuarter" CssClass="form-control" Enabled="false">
                                        </asp:DropDownList>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtScore" CssClass="form-control" oninput="DecimalCheck(this)" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
