<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddWFDataTracking.aspx.cs" Inherits="CF.AddWFDataTracking" UnobtrusiveValidationMode="none" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Woman Farmer Data</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <ContentTemplate>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtYear" runat="server" CssClass="form-control YearPicker" OnTextChanged="txtYear_TextChanged" oninput="NumberCheck(this)" MaxLength="4"></asp:TextBox>
    ...
    <script>
        $(document).ready(function () {
            ...
            document.getElementById('dvFPCName').style.display = "none";
        });
