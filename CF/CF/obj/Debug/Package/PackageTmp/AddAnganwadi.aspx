<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="AddAnganwadi.aspx.cs" Inherits="CF.AddAnganwadi" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Anganwadi Details</title>
    <style>
        .LableSpace, label {
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Anganwadi Details</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <asp:Label ID="Label10" runat="server" Text="Hamlet"></asp:Label>
