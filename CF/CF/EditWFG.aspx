<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="EditWFG.aspx.cs" Inherits="CF.EditWFG" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit WFG</title>
    <style>
        .Preview {
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit WFG</h3>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content" id="printableArea">
                        ...
                        <div class="box-footer clearfix">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Update" OnClick="btnSubmit_Click" />
