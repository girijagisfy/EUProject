<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="EditCroppingPattern.aspx.cs" Inherits="CF.EditCroppingPattern" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit Cropping Pattern</title>
    <style>
        .LableSpace, label {
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Cropping Pattern</h3>
