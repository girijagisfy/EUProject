...
namespace CF
{
    public partial class HamletDataInfo : System.Web.UI.Page
    {
        ...
        {
            string vidCondetion = Session["Hid"].ToString();

            string selectQ = "SELECT a.[Hid],a.[HDid],[Village],[NameofHamlet],[Year], [Rank] FROM tblHamletData a left outer join [dbo].[tblHamletInfo] b on a.Hid=b.Hid left outer join [tblVillageInfo] c on b.[Villageid]=c.[Vid] left outer join tblVillages d on c.VillageID=d.VillageID where 1=1 and a.[Hid]=" + vidCondetion;
        ...
        protected void Gridview1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("btnEdit"))
            {
                ...
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
                Session["HDid"] = val;

                Response.Redirect("EditHamletData.aspx");
            }
            else if (e.CommandName.Equals("btnService"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
            ...
            else if (e.CommandName.Equals("btnFinance"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
            ...
            else if (e.CommandName.Equals("btnAnganwadi"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
            ...
            else if (e.CommandName.Equals("btnCropping"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
                Session["HDid"] = val;
                Response.Redirect("CroppingInfo.aspx");
            }
            else if (e.CommandName.Equals("btnprevalentDiseases"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
            ...
            else if (e.CommandName.Equals("btnSkillDevelopment"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
            ...
            else if (e.CommandName.Equals("btnLivestock"))
            {
                string strid = e.CommandName.ToString();
                int rowIndex = int.Parse(e.CommandArgument.ToString());
                string val = (string)this.Gridview1.DataKeys[rowIndex]["HDid"].ToString();
