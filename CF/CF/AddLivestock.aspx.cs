...
namespace CF
{
    public partial class AddLivestock : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO [dbo].[tblNaturalResouce_Livestock] ([Hamletid],[LiveStockName],[HHofLivestock],[Population],[Disease],[Mortality],[AverageIncome])  VALUES(" + Hid + ",'" + name + "','" + HH + "','" + population + "','" + Disease + "','" + Mortality + "','" + income + "')";
